// In any language strings are very powerfull

// There are many ways to create a string in JS.

// 1) Directly declaring string
const str = "newString"

// 2) Using new keyword
const newStr = new String("String using new keyword")
